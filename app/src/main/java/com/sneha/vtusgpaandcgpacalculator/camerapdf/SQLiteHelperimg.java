...
public class SQLiteHelperimg extends SQLiteOpenHelper {
    public SQLiteHelperimg(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
